...
# Serializes the check-then-write sections of booking creation and
# cancellation so conflict, quota and refund invariants hold under
# concurrent requests.
...
def cancel_booking(
    ...
    with _booking_lock:
        ...
        # Half-cents round up: integer arithmetic avoids float rounding drift.
